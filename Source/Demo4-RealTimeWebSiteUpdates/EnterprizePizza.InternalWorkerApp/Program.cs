...
namespace EnterprizePizza.InternalWorkerApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Starting the Inventory Service");
            program.StartInventoryService();
            ...
            Console.WriteLine("Stopping the Inventory Service");
            program.StopInventoryHost();

            Console.WriteLine("Exiting");
        }

        ServiceHost _inventoryHost;
        
        private void StartInventoryService()
        {
            _inventoryHost = new ServiceHost(typeof(CorporateOfficeInventoryService));
            _inventoryHost.Open();
        }

        private void StopInventoryHost()
        {
            _inventoryHost.Close();
        }
